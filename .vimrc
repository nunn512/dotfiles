...
let g:vim_editor = "vim"				" nvim or vim
...
" But that breaks vim-go omnifunc completion (seems that vim-go uses the same
" func definitions):
" Error detected while processing
" /home/ubuntu/.vim/plugged/vim-polyglot/autoload/go/config.vim:
" line  426:
" E122: Function go#config#FoldEnable already exists, add ! to replace it
" Error detected while processing function go#complete#Complete:
" line    3:
" E171: Missing :endif
" Solution: define it here - so it gets instatiated after vim-go
...
" syntastic
noremap <F8> :SyntasticToggleMode<CR> :w<CR>
...
autocmd FileType go colorscheme Benokai
autocmd FileType go set tags=./tags;,tags
...
" proto
autocmd FileType proto setlocal autoindent tabstop=4 shiftwidth=4 textwidth=80 noexpandtab
...
"" Custom variables
"*****************************************************************************
let g:gitgutter_max_signs = 10000 "default 500
